...
def predict(filename):
	...
	print(pred)
	pred1 = " has pnemonia"
	pred2 = "is not having pnemonia"
	#string_result = "This image"+ 
	li = ["normal","pnemonia"]
	label = random.choice(li)
	if answer == 0:
		string_result = "This image "+pred1
		return render_template('test1.html',results=string_result)
	if answer == 1:
		string_result = "This image "+pred2 
		return render_template('test1.html',results=string_result)
